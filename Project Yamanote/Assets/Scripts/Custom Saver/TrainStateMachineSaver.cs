...
{
    public class TrainStateMachine_Saver : Saver
    {
        public override string RecordData()
        {
            ...
            var trainState = GetComponent<Station>();
            return trainState.ToString();
        }
        ...
        public override void ApplyData(string data)
        {
            ...
            var trainState = GetComponent<Station>();
            var s = SaveSystem.Deserialize(data, trainState);

            s.StateMachine.ChangeState(s.StateMachine.CurrentState);
        }
